...
export class Game {
 ...
 tickPreparation(dt){for(const h of this.state.heroes){h.moving=false;if(h.hp>0&&distance(h,h.home)>.015)this.walk(h,h.home,dt);}for(const ef of this.state.effects)ef.ttl-=dt;this.state.effects=this.state.effects.filter(e=>e.ttl>0);}
